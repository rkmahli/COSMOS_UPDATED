package demo.cosmos.core.policy.api.exception;
...
@ControllerAdvice
public class PolicyServiceExceptionHandler extends ResponseEntityExceptionHandler {
	private static final Logger LOG = LoggerFactory.getLogger(PolicyServiceExceptionHandler.class);
